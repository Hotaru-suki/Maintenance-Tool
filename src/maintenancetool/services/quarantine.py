...
from maintenancetool.core.cleanup import delete_quarantine_records, list_quarantine_records, restore_quarantine_records
...
def run_delete_staged_service(
    *,
    ...
    execution = delete_quarantine_records(
        quarantine_dir=quarantine_dir,
        record_ids=record_ids,
    )
    report_path = write_restore_execution_report(report_dir, execution)
